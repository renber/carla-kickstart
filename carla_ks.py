...
from carla_kickstart.behaviors.automatic import DriveToLocationBehavior
...
if __name__ == "__main__":
    try:
        ...
        behaviors = CompoundBehavior(DriveToLocationBehavior(), RouteRecorderBehavior("recorded_route.csv"))
